...
public class DesktopInputProcessor extends PDInputProcessor {
	...
	static {
		...
		DEFAULTS.put( GameAction.MOVE_UP, new KeyPair( Input.Keys.UP) );
		DEFAULTS.put( GameAction.MOVE_DOWN, new KeyPair( Input.Keys.DOWN) );
		DEFAULTS.put( GameAction.MOVE_LEFT, new KeyPair( Input.Keys.LEFT ) );
		DEFAULTS.put( GameAction.MOVE_RIGHT, new KeyPair( Input.Keys.RIGHT) );
		...
		DEFAULTS.put( GameAction.MOVE_UP_BUDD, new KeyPair( Input.Keys.Z ) );
		DEFAULTS.put( GameAction.MOVE_DOWN_BUDD, new KeyPair( Input.Keys.X ) );
		DEFAULTS.put( GameAction.MOVE_LEFT_BUDD, new KeyPair( Input.Keys.C ) );
		DEFAULTS.put( GameAction.MOVE_RIGHT_BUDD, new KeyPair( Input.Keys.V ) );
		DEFAULTS.put( GameAction.TAG_ATTACK_BUDD, new KeyPair( Input.Keys.N ) );
	};
