...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		hero = new HeroSprite(false);
		hero.place( Dungeon.hero.pos );
		hero.updateArmor();
		mobs.add( hero );

		//Add buddy code
		buddy = new HeroSprite(true);
		buddy.place(Dungeon.buddy.pos);
		buddy.updateArmor();
		buddy.setImBuddy();
		mobs.add(buddy);
	...
	private void addMobSprite( Mob mob ) {
		...
		sprite.visible = Dungeon.level.heroFOV[mob.pos] || Dungeon.level.buddyFOV[mob.pos];
		mobs.add( sprite );
		sprite.link( mob );
	}
	...
	public static void afterObserve() {
		if (scene != null) {
			for (Mob mob : Dungeon.level.mobs) {
				if (mob.sprite != null)
					mob.sprite.visible = Dungeon.level.heroFOV[mob.pos] || Dungeon.level.buddyFOV[mob.pos];
			}
		}
	}
	...
	public static void examineCell( Integer cell ) {
		...
		if (cell == Dungeon.hero.pos|| cell == Dungeon.buddy.pos) {
			objects.add(Dungeon.hero);
			names.add(Dungeon.hero.className().toUpperCase(Locale.ENGLISH));
		} else {
			if (Dungeon.level.heroFOV[cell] || Dungeon.level.buddyFOV[cell]) {
