...
public abstract class Char extends Actor {
	...
	protected boolean[] fieldOfViewBuddy = null;
	private boolean imbuddy = false;
	private Char myLord = null;

	public void charisBuddy(Char myLord){
		this.myLord = myLord;
		imbuddy = true;
	}
	...
	public void damage( int dmg, Object src ) {
		...
		if (src instanceof Hunger || SHLD == 0){
			if(this instanceof Hero && imbuddy){
				myLord.HP -= dmg;
				//myLord.HP = 0;
			}else {
				HP -= dmg;
	...
	public void move( int step ) {
		...
		if (this != Dungeon.hero || this != Dungeon.buddy) {
			sprite.visible = Dungeon.level.heroFOV[pos] || Dungeon.level.buddyFOV[pos];
		}

		//if(this != Dungeon.buddy){
