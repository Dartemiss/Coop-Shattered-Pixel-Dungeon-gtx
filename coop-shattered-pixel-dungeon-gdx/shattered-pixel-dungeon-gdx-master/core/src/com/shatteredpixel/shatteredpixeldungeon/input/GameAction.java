...
public enum GameAction {
	...
	//Buddy actions
	MOVE_UP_BUDD("Move Buddy North"),MOVE_DOWN_BUDD("Move Buddy South"), MOVE_LEFT_BUDD("Move Buddy West"), MOVE_RIGHT_BUDD("Move Buddy East"),
	MOVE_TOP_LEFT_BUDD("Move Buddy NW"), MOVE_TOP_RIGHT_BUDD("Move Buddy NE"), MOVE_BOTTOM_LEFT_BUDD("Move Buddy SW"), MOVE_BOTTOM_RIGHT_BUDD("Move Buddy SE"),
	OPERATE_BUDD("Current Buddy Cell"),
	TAG_ATTACK_BUDD("Buddy Attack"),
	REST_BUDD("Buddy Rest"),
